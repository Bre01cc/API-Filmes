create table tbl_profissional(
 ...
 foto_ator varchar(100) not null,
...
INSERT INTO tbl_profissional (nome, data_nascimento, nome_artistico, foto_ator, status, data_falecimento, rede_social, biografia)
VALUES
('João Silva', '1985-03-12', 'João S.', 'joao_silva.jpg', TRUE, NULL, '@joaosilva',
...
('Maria Souza', '1990-07-25', 'Maria S.', 'maria_souza.jpg', TRUE, NULL, '@mariasouza',
...
('Carlos Pereira', '1978-11-05', 'Carlos P.', 'carlos_pereira.jpg', TRUE, NULL, '@carlosp',
...
('Ana Oliveira', '1988-02-19', 'Ana O.', 'ana_oliveira.jpg', TRUE, NULL, '@anaoliveira',
...
('Rafael Costa', '1982-09-14', 'Rafa Costa', 'rafael_costa.jpg', TRUE, NULL, '@rafacosta',
...
('Fernanda Lima', '1992-06-30', 'Fê Lima', 'fernanda_lima.jpg', TRUE, NULL, '@ferlima',
...
('Bruno Martins', '1975-12-01', 'Bruno M.', 'bruno_martins.jpg', FALSE, '2022-05-10', '@brunom',
...
('Camila Rocha', '1987-08-22', 'Cami R.', 'camila_rocha.jpg', TRUE, NULL, '@camilarocha',
...
('Lucas Fernandes', '1995-01-15', 'Luc F.', 'lucas_fernandes.jpg', TRUE, NULL, '@lucfernandes',
...
('Patrícia Almeida', '1983-04-10', 'Paty A.', 'patricia_almeida.jpg', TRUE, NULL, '@paty_almeida',
